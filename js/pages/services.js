...
export const renderServicesPage = (store) => {
    const container = document.createElement('div');
    container.className = 'container';
    
    container.innerHTML = `
        <h1 style="margin-bottom: 2rem;">🔧 Дополнительные услуги</h1>
            ...
            <div class="grid-3">
                <div>
                    ...
                    <select id="carBrand">
                        ...
                        <option>Nissan</option><option>Ford</option><option>Chevrolet</option>
                    </select>
                </div>
